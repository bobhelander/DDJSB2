...
namespace DDJSB2.Layout
{
    public static class Encoders
    {
        ...
        // Channel 7
        public static Encoder BrowseEncoder => new Encoder { Name = "Browse", NoteNumber = 0x41, ControlNumber = 0x40, Cutoff = 0x40 };
        public static Encoder BrowseShiftedEncoder => new Encoder { Name = "Browse Shifter", NoteNumber = 0x42, ControlNumber = 0x64, Cutoff = 0x40 };
    }
}
